"""Column-aware narrative extraction for Philadelphia Fed MBOS release PDFs.
...
_BOILER = re.compile(
    ...
    r"|note\s*:\s*survey responses|for more regional economic|federal reserve bank of philadelphia"
...
def paragraphs(pdf_path_or_bytes, max_pages: int = 3) -> List[Tuple[str, bool]]:
    ...
    def continues(nxt: str, nxt_bold: bool) -> bool:
        ...
        if nxt_bold or nxt.isupper():
            return False
        return bool(re.match(r"[a-z(]|Chart \d\)", nxt))
