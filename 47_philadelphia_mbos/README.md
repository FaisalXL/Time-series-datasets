...
| | |
|---|---|
| **What** | The release's prose: executive summary + (recent years) detailed index sections. Describes general activity, new orders, shipments, employment, prices, and the 6-month outlook. |
...
```json
{
  ...
  "bank": "Federal Reserve Bank of Philadelphia", "survey": "Manufacturing Business Outlook Survey",
  "district": 3, "domain": "manufacturing", "release_month": "2026-06", "window_months": 24,
  "dataset": "philadelphia_mbos", "license": "Public domain (U.S. Government / Federal Reserve)",
  "source": "Federal Reserve Bank of Philadelphia Manufacturing Business Outlook Survey (U.S. public domain)",
  "series_id": "mbos_2026-06"
}
```
...
- **Volume:** ≈ 190 monthly records (2010→). No short-series problem (every window is a full 24 months).
...
python scripts/build_cpt_jsonl.py --set output.max_records=null          # full build (~190)
```
